...
public class Fighter {
    ...
    /**
     * Retrieves the names of the fighters.
     * @return the fighter's name.
     */
    public String getName() { return name; }
    
    /**
     * Retrieves the current hit points of the fighter.
     * @return the fighter's HP.
     */
    ...
    /**
     * Retrieves the base attack power of the fighter.
